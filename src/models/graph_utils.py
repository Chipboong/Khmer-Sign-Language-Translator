...
Direct port from PyTorch reference implementation
"""
...
def get_hop_distance(num_node, edge, max_hop=1):
    """Compute hop distance matrix using BFS"""
    # link matrix
...
def get_spatial_graph(num_node, self_link, inward, outward):
    """Get spatial graph with 3 partitions"""
...
class GraphWithPartition:
    """
    The Graph to model the skeletons with spatial partitioning
    ...
    Args:
        ...
        strategy (string): Partitioning strategy ('uniform', 'distance', 'spatial')
        max_hop (int): Maximal distance between two connected nodes. Default: 1
        dilation (int): Controls spacing between kernel points. Default: 1
    """
    ...
    def get_adjacency(self, strategy):
        """Build adjacency matrix based on partitioning strategy"""
...
class SpatialGraph:
    """
    Graph construction with equal weight to all nodes
    
    Args:
        num_nodes (int): Number of spatial nodes in the graph
        inward_edges (list): List of spatial edges connecting the skeleton
        strategy (str): Partitioning strategy. Default: 'spatial'
    """
